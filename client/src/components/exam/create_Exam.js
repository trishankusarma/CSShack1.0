    ...
    return(
         <>   
              ...
              <form onSubmit={onSubmit} id="hello">
                ...
                <h1 className="settime" style={{color:'white'}}>Set Time</h1>
            
                <input type="Number"  className="newexambutton_time" name='hour' onChange={handleChange} value={hour} required/><br />
              
                <input type="Number"  className="newexambutton_time" name='minute' onChange={handleChange} value={minute} required/><br />
